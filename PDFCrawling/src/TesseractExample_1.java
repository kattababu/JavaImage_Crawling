...
public class TesseractExample_1 {

    public static void main(String[] args) throws Exception {
        File imageFile = new File("/home/headrun/workspace/PDFCrawling/src/Headrun-858x554.jpg");
        ...
        try {
        	...
        	Rectangle rect = new Rectangle(17,166,570,95);
        	String name = instance.doOCR(img, rect).trim();
            System.out.println("Name:"+name);
            ...
            Rectangle rect4 = new Rectangle(17,270,270,56);
        	
        	String name4 = instance.doOCR(img, rect4).trim();
            System.out.println("DOJ:"+name4.replace(" ","").trim());
