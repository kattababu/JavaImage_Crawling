...
public class Cropper {
    ...
    public static void main(String[] args) throws IOException {
        BufferedImage src = ImageIO.read(new File("/home/headrun/workspace/PDFCrawling/src/Headrun.bmp"));
        int x0=src.getWidth();
        ...
        if (x1>x0 && y1>y0)
        {
            ...
            ImageIO.write(dest, "bmp", new File("/home/headrun/workspace/PDFCrawling/src/Headrun_M.bmp"));
